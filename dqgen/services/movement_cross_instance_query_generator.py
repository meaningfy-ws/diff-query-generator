...
class SimplePropertyMovementCrossInstanceGenerator(BaseQueryGenerator):
    """
        This class will build the movement of the property and value to another instance query as a file and
    ...
    def build_query_template(self):
        template = QueryTemplateRegistry().PROPERTY_MOVEMENT_CROSS_INSTANCE
